...
class Google(Cog, name="Google"):
    ...
    async def __search(self, context: Union[Context, SlashContext], search_type: SearchType, query: str) -> None:
        try:
            ...
            await self.__reply(context, "The daily search quota has been used up for the bot. Please, try again later or contact your server administrator.")
    ...
    async def __reply(self, context: Union[Context, SlashContext], message: str) -> None:
