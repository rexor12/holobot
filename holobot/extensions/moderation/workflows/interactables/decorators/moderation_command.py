...
from holobot.extensions.moderation.workflows.interactables import ModerationCommand

def moderation_command(
    *,
    description: str,
    name: str | None = None,
    ...
    of a workflow into a moderation command.
    ...
    :param required_moderator_permissions: Any required moderator permissions, defaults to ModeratorPermission.NONE
    :type required_moderator_permissions: ModeratorPermission, optional
    ...
    def wrapper(target: Callable[..., Coroutine[Any, Any, Any]]):
        setattr(target, DECORATOR_METADATA_NAME, ModerationCommand(
            callback=target,
